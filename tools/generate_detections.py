...
class ImageEncoder(object):
    ...
    def __init__(self, checkpoint_filename, input_name="images",
        ...
        # Session, GraphDef, get_default_graph have been deprecated. Backwards compatibility with tf.compat.v1
        # import_graph_def still exists in TF 2.x, but using the .v1 version ensures compatibility with the TensorFlow 1.x API
        # gfile has been moved from tf to tf.io
